...
"Se obtiene de Etherscan ingresando al address del token"
...
"Se verifica que estemos conectados a el Token"
contract = web3.eth.contract(address=address, abi=abi)
#print(contract)

"Se obtiene el Total max Supply"
totalSupply = contract.functions.totalSupply().call()
print(web3.from_wei(totalSupply, 'ether'))
"Se obtiene el nombre, abreviatura y el balance de una cuenta que contenga este token"
